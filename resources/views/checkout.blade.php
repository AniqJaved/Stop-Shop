                                    ...
                                    @foreach(Cart::content() as $pdt)
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-subtotal">
                                                <h5 class="total amount">${{$pdt->price}}</h5>
                                            </td>
								...
								<form action="{{route('checkout')}}" method="POST">
                                    {{csrf_field()}}
									  <script
                                              ...
                                              data-key="pk_test_51Hi5GiJr7TcWtrcsnd1P3RxMgTbMUxK4FhSNVYr8nz2Ine8ryF2wbHLzZdzJ3Ee2Syj3ULqI2UhgVX05jyyLtaZY00zrwrpvx5"
