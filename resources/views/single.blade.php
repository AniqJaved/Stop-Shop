            ...
            <div class="product-details">
                        ...
                        <div class="swiper-container" data-effect="fade">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="product-details-img-wrap swiper-slide">
                                    <img src="{{asset($products->photo)}}" alt="product" data-swiper-parallax="-10">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                    <div class="product-details-info">
                        ...
                        <p class="product-details-info-text">{{$products->description}}
                        </p>


                        {!! Form::open(['method'=>'POST','action'=>'ShoppingController@add_to_cart']) !!}
                            {{ Form::hidden('pdt_id', $products->id) }}
                            <div class="quantity">
